...
import { updateTask, getApiOrigin } from '../services/api';
import './CreateProjectForm.css'; // Reusing modal styles

const EditTaskForm = ({ task, teamMembers, onClose, onTaskUpdated }) => {
    ...
    useEffect(() => {
        if (task) {
            setFormData({
                ...
                assignedTo: task.assignedTo ? task.assignedTo.map(u => typeof u === 'string' ? u : u._id) : []
            });
        }
    }, [task]);
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="submit" className="btn btn-primary" disabled={loading}>
                            {loading ? 'Save Changes' : 'Save Task'}
                        </button>
                    </div>
                </form>
            </div >
